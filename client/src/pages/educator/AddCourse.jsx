...
const AddCourse = () => {
  ...
  return (
    <div className='flex flex-col items-start justify-between h-screen p-4 pt-8 pb-0 overflow-scroll md:p-8 md:pb-0'>
      <form onSubmit={handleSubmit} className='flex flex-col w-full max-w-md gap-3 text-gray-500'>
        ...
        <div>
            ...
            <div key={chapterIndex} className='mb-4 bg-white border rounded-lg'>
              ...
              {!chapter.collapsed && (
                <div className='p-4'>
                  ...
                  <div className='inline-flex p-2 mt-2 bg-gray-100 rounded cursor-pointer' onClick={() => handleLecture('add', chapter.chapterId)}>
                    + Add lecture
                  </div>
                </div>
              )}
          ...
          <div className='flex items-start justify-center p-2 bg-blue-100 rounded-lg cursor-pointer' onClick={()=> handleChapter('add')}>
            + Add Chapter
          </div>
              ...
              <div className='relative w-full p-4 text-gray-700 bg-white rounded max-w-80'>
                ...
                <div className='mb-2'>
                  ...
                  <input
                    ...
                    onChange={(e) => setLectureDetails({...lectureDetails, lectureTitle: e.target.value})} required
                  />
                </div>
                ...
                <div className='mb-2'>
                  ...
                  <input
                    ...
                    onChange={(e) => setLectureDetails({...lectureDetails, lectureDuration: e.target.value})} required
                  />
                </div>
                ...
                <div className='mb-2'>
                  ...
                  <input
                    ...
                    onChange={(e) => setLectureDetails({...lectureDetails, lectureUrl: e.target.value})} required
                  />
                </div>
                ...
                <button onClick={addLecture} type='button' className='w-full px-4 py-2 text-white bg-blue-400 rounded'>Add</button>

                <img onClick={() => setShowPopup(false)} src={assets.cross_icon} alt="" className='absolute w-4 cursor-pointer top-4 right-4' />
              </div>
            </div>
          )}
        </div>
